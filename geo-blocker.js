...
(function($) {
    ...
    var blockForms = function(reason) {
        // If server-side blocking was already applied, don't double-block
        if (window.ffbServerBlocked === true) {
            console.log('Server-side blocking already applied, skipping client-side blocking');
            return;
        }
